<template>
  <div id="app">
        ...
        <div class="scroll-wrap flex-col">
          <ul class="nav">
            <li v-for="(item, index) in asides"
              ...
              <a :href="item.path" :target="item.target ? item.target : '_self'">
    ...
    <div class="mask" id="mask" :class="{show: !isCollapsed}" @click="TOGGLE_COLLAPSE(true)"></div>
    <div id="goto" @click="handleGoto">
